...
def extract_gear_data(query):
   ...
   try:
      ...
      # get the searching critaria form
      ...
      for result in filtered_results :
         try:
            ...
            #gear free text description: append free texts description relativer to gear
            description = ""
...
def get_locations(locations_csv):
   """ Extract the city from the locations csv
...
if __name__ == "__main__":
   # Build the Queries to be scraped
